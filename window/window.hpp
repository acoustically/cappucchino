...
public:
  ...
  Position get_end_position(); /* return end coordinates of window
    * returns :
    *   Position end : end coordinates of window */
  void set_start_position(int x, int y); /* set start coordinates of window */
  void set_start_position(Position position);
  void set_end_position(int x, int y); /* set start coordinates of window */
  void set_end_position(Position position);
